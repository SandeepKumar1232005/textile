...
export function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section 
        className="relative bg-[#FAFAF8] bg-cover bg-no-repeat bg-center md:bg-[right_center] py-24 md:py-32 px-4 border-b border-[#EAEAEA] min-h-[520px] flex items-center"
        style={{ backgroundImage: "url('/hero-bg.png')" }}
      >
        {/* Subtle overlay for better readability on small screens */}
        <div className="absolute inset-0 bg-white/40 md:bg-transparent z-0"></div>
        ...
        <div className="relative max-w-7xl mx-auto w-full z-10">
          <div className="max-w-xl md:max-w-2xl">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-semibold leading-[1.1] text-brand-black mb-6 tracking-tight">Style, Comfort & Quality in Every Thread</h1>
              <p className="text-[#4A4A4A] leading-relaxed mb-8 text-[15px] max-w-lg font-medium">
            ...
            >
              ...
              <a 
                ...
                className="w-full sm:w-auto border border-[#25D366] text-[#25D366] px-8 py-4 bg-white/80 text-sm font-medium tracking-wide uppercase flex items-center justify-center gap-2 hover:bg-[#25D366] hover:text-white transition-all"
              >
          ...
          <div className="flex gap-2.5 mt-16 md:mt-24">
            <span className="w-2.5 h-2.5 rounded-full bg-[#B8912F]"></span>
