...
export function About() {
  return (
    <div className="min-h-screen bg-white max-w-4xl mx-auto px-4 sm:px-10 py-20">
      <motion.div
        className="mb-16 border-b border-[#EAEAEA] pb-10"
      ...
      <div className="space-y-12">
        <motion.section
          className="text-[15px] leading-relaxed text-[#4A4A4A] space-y-6"
          initial={{ opacity: 0, y: 16 }}
        ...
        <motion.section
          className="grid md:grid-cols-2 gap-8 mt-16 pt-16 border-t border-[#EAEAEA]"
          initial={{ opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-80px' }}
          transition={{ duration: 0.45, ease: 'easeOut' }}
